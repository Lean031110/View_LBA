...
| # | Página | Qué contiene |
|---|---|---|
| 1 | [[Sistema-de-Licencias]] | Arquitectura general, estados, flujo end-to-end |
| 2 | [[Claves-Ed25519]] | **Cómo se generan las claves** (par Ed25519), formatos, dónde vive cada clave |
| 3 | [[Secret-de-GitHub-Actions]] | `VIEWLBA_LICENSE_PRIVATE_KEY`: qué es, cómo se creó, cómo verificarlo y rotarlo |
| 4 | [[Emisión-de-Licencias]] | Las 3 vías de emisión: CLI, GitHub Actions y demo web — paso a paso |
| 5 | [[Planes-y-Precios]] | Trial 7 días · Mensual 30 días/USD 10 · Anual 365 días/USD 100 |
| 6 | [[Binding-Hardware-y-Disco]] | Installation ID (`VWLB-…`), Disk ID (`DSK-…`), fingerprint |
| 7 | [[Trial-de-7-días]] | Mecánica, anclas duales, anti-manipulación de reloj |
| 8 | [[Importación-de-Licencia]] | Flujo del cliente (ZIP), validaciones y errores |
| 9 | [[Seguridad]] | Dónde NO está la clave privada, matriz de ataques y mitigaciones |
| 10 | [[Mantenimiento-y-Rotación]] | Rotación de claves, checklist de release, troubleshooting |
...
- **Workflow de emisión:** GitHub → pestaña **Actions** → **License Generator** → *Run workflow* (ver [[Emisión-de-Licencias]]).
