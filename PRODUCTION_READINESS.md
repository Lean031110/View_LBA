...
> Fecha: 2026-09-09 · Rama: `main` · Progreso detallado: `PRODUCTION_PLAN.md`.
...
- **Versión actual del código: 1.0.0** (package.json) — CHANGELOG documenta 1.0.0 y 1.1.0 (features de UI).
- **Versión final propuesta: 1.2.0** — producción real: seguridad, pairing, recovery, offline, perf y documentación (este documento la respalda).
